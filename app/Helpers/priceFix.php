...
class priceFix
{
    public static function priceFixer($sparepart_id)
    {
        ...
        $new_harga = Round::roundToNearest(ceil($harga_modal + $harga_modal * ($sparepart->margin/100)));
        // $new_harga = Round::roundToNearest(ceil($harga_modal + $harga_modal * ($sparepart->margin/100) + ($sparepart->is_pajak? $harga_modal*12/100:0)));
