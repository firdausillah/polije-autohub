...
class ServiceHistoryResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'serviceDServices' => ServiceDServicesResource::collection(
                $this->whenLoaded('serviceDServices')
            ),
            'serviceDChecklist' => ServiceDChecklistResource::collection(
                $this->whenLoaded('serviceDChecklist')
            ),
            'serviceDSparepart' => ServiceDSparepartResource::collection(
                $this->whenLoaded('serviceDSparepart')
            ),
            'serviceDPayment' => ServiceDPaymentResource::collection(
                $this->whenLoaded('serviceDPayment'),
            ),
        ];
    }
}
